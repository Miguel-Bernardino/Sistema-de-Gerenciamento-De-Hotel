    ...
    return (
        <>
            ...
            <Modal 
                ...
                >
                <ol className='h-[90vh]'>
                    <header onClick={() => setIsModalOpen(false)} className='w-full h-[15%] flex justify-start'>
                    ...
                    <main className='h-[55%] gap-[2vh] md:gap-[2vh] flex flex-col align-center justify-start'>
                        
                        {/*------------------HOME PAGE------------------------*/}
                        <li className={`${style.modalItem} ${isActive('/home') ? style["sidebar-li-active"] : ''}`}>    
                            {isActive('/home') && <HighlightIndicator inline={true} />}
                            <a href="/home" className="flex items-center " onClick={(e) => { setFocusPage('/home') }}>
                        ...
                        <li className={`${style.modalItem} ${isActive('/statistics') ? style["sidebar-li-active"] : ''}`}>
                            ...
                            <a href="/statistics" className="flex items-center" onClick={(e) => { setFocusPage('/statistics') }}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 105.98" className={`${style.modalItemIcon} ${style.modalItem.fill}`}>
                        ...
                        <li className={`${style.modalItem} ${isActive('/finance') ? style["sidebar-li-active"] : ''}`}>
                            ...
                            <a href="/finance" className="flex items-center" onClick={(e) => { setFocusPage('/finance') }}>
                                <svg id="Layer_1" className={`${style.modalItemPriceIcon} ${style.modalItem.color}`} data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="-0 -38 192.88 170.81">
                    ...
                    <footer className=' gap-[2vh] md:gap-[2vh] flex flex-col h-[30%] justify-end'>
                        {/*--------------------------CONFIG PAGE------------------------*/}
