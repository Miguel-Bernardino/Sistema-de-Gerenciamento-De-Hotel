...
export const SidebarDesktop: React.FC<any> = ( { isActive, focusPage, setFocusPage, ...props }) => {
                ...
                <ol className={style.list}>
                    <main className="">
                        ...
                        <li className={`${style["sidebar-li"]} ${isActive('/home') ? style["sidebar-li-active"] : ''}`}>    
                            {isActive('/home') && <HighlightIndicator inline={isHovered} />}
                            <a href="/home" className="flex items-center h-[50px] w-[50px]" onClick={(e) => { setFocusPage('/home') }}>
                        ...
                        {/*------------------STATISTIC PAGE------------------------*/}
                        <li className={`${style["sidebar-li"]} ${isActive('/statistics') ? style["sidebar-li-active"] : ''}`}>
                            {isActive('/statistics') && <HighlightIndicator inline={isHovered} />}
                            <a href="/statistics" className="flex items-center" onClick={(e) => { setFocusPage('/statistics') }}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 105.98" className={`${style.sidebarItem}`}>
                        ...
                        {/*------------------PRODUCTS PAGE------------------------*/}
                        <li className={`${style["sidebar-li"]} ${isActive('/products') ? style["sidebar-li-active"] : ''}`}>
                            <a href="/products" className="flex items-center" onClick={(e) => { setFocusPage('/products') }}>
                                {isActive('/products') && <HighlightIndicator inline={isHovered} />}
                                <svg className={style.sidebarItem} viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className={`${style["sidebar-li"]} ${isActive('/finance') ? style["sidebar-li-active"] : ''}`}>
                            {isActive('/finance') && <HighlightIndicator inline={isHovered} />}
                            <a href="/finance" className="flex items-center" onClick={(e) => { setFocusPage('/finance') }}>
            ...
            <footer className="w-full mt-auto">
                <ol className={style.list}>
                    ...
                    <li className={`${style["sidebar-li"]} ${isActive('/config') ? style["sidebar-li-active"] : ''}`}>                        
                        ...
                        <a href="/config" className="flex items-center" onClick={(e) => { setFocusPage('/config') }}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={style.sidebarItem}>
                    ...
                    {/*--------------------------LOGOUT PAGE------------------------*/}
                    <li className={`${style["sidebar-li"]} ${isActive('/logout') ? style["sidebar-li-active"] : ''}`}>
                        {isActive('/logout') && <HighlightIndicator inline={isHovered} />}
                        <a href="/logout" className="flex items-center" onClick={(e) => { setFocusPage('/logout') }}>
